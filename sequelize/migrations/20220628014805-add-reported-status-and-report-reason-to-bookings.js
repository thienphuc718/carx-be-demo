...
module.exports = {
  async up(queryInterface, Sequelize) {
    ...
    return queryInterface.sequelize.query(`
      alter type "enum_bookings_status" add value 'REPORTED'
    `);
  },
  ...
  async down(queryInterface, Sequelize) {
     ...
     */
    return queryInterface.sequelize.query(`
      create type "enum_bookings_status_new" as enum ('CREATED', 'CONFIRMED', 'PROCESSING', 'WAITING_FOR_PAYMENT', 'COMPLETED', 'CANCELLED');
